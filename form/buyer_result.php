...
if (mysqli_connect_error()) {
    ...
    $sql = 'SELECT STREET, STREET_NUMBER, PRICE, SIZE, AREA, NUMBER_OF_ROOMS FROM PROPERTIES JOIN SELL ON PROPERTIES.ID = SELL.PROPERTY_ID 
    ...
    ?>
    <!-- Body Begin -->
    <div class="table-title col-xl-6 col-md-10"><h3>Buyer Flow Results</h3></div>
